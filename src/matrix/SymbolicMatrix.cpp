...
//     this->isInputMatrix = false;
//     this->numChilds = 1; // this is a unary operation
...
// // SymbolicMatrix::SymbolicMatrix(const OpTypeMatrix opm, const vector<SymbolicMatrix>& ms): childs(new SymbolicMatrix[ms.size()]){
// //     this->isInputMatrix = false;
// //     this->numChilds = 1;
// //     copy_n(ms.begin(), this->numChilds, const_cast<SymbolicMatrix*>(childs));
